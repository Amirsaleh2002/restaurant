...
function AboutUs() {
  return (
    ...
    <div className="about-us">
      ...
      <img src="./img/download.jpg" alt="restauran-image" className="about-us-img" />
      ...
      <img src="./img/images (1).jpg" alt="restauran-image" className="about-us-img" />
      <h2 className="about-us-title">چرا ادعا داریم بهترینیم؟؟
      </h2>
      <p className="about-us-text">
        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده
        از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و
      ...
      <img src="./img/images.jpg" alt="restauran-image" className="about-us-img" />
    </div>
